describe( "Math / Round", function() {
    ...
    it( 'should output input rounded to nearest integer', function( done ) {
    ...
    it( 'should round < 0 && >= -1 to -1', function( done ) {
        var _io = new AudioIO( new OfflineAudioContext( 1, 44100 * 0.001, 44100 ) ),
            _node,
            input,
            val = -0.9;
    ...
    it( 'should round values > 1 to 1.', function( done ) {
        var _io = new AudioIO( new OfflineAudioContext( 1, 44100 * 0.001, 44100 ) ),
            _node,
            input,
            val = 12.5;
