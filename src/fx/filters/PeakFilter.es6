...
class PeakFilter extends Node {
    constructor( io ) {
        ...
        graph.lp12dB.type = 'peak';
        graph.lp24dB.type = 'peak';
        ...
        this.setGraph( graph );
        this.addControls( PeakFilter.controlsMap );
    }
}

PeakFilter.controlsMap = {
    slope: {
...
AudioIO.prototype.createPeakFilter = function() {
    return new PeakFilter( this );
};

export default PeakFilter;